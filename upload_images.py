...
# Images is an Enterprise entitlement, for the labs the instructor will provide you a temporary token that you can leverage
images_token = "ENTER IMAGES API TOKEN HERE"
images_account_id = "ENTER ACCOUNT ID FOR IMAGES HERE"
